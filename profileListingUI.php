...
if (!class_exists('profileListingUI')) {
    ...
    class profileListingUI extends profileListingCommonFeatures {
        ...
        public function get_profiles_data($request) {
            ...
            $args = $this->apply_sorting_and_searching_for_profiles($column_index, $sorting_direction, $lenght, $offset, $keyword, $apply_advance, $age, $rating, $jobs_completed, $years_experience, $skills, $education);
